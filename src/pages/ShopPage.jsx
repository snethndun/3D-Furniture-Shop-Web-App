...
const ShopPage = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative overflow-hidden bg-gray-50 min-h-screen"
    >
      {/* 🔆 Glow Layer */}
      <div
        ref={glowRef}
        ...
        style={{
          background:
            "radial-gradient(circle at var(--x) var(--y), rgba(0, 180, 265, 0.15), transparent 20%)",
      ...
      <div className="relative z-10 py-12 px-4 sm:px-8">
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <div className="text-center mb-12 bg-gradient-to-r from-blue-500 to-indigo-600 p-8 rounded-lg">
